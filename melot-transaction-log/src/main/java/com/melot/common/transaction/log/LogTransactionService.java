package com.melot.common.transaction.log;
...
import com.melot.common.transaction.history.EventHistory;
import com.melot.common.transaction.history.History;
import com.melot.common.transaction.history.TransactionHistory;
import com.melot.common.transaction.util.LogUtils;
...
public class LogTransactionService {
	...
	public Object processWithTransactionLog(ProceedingJoinPoint pjp,
		...
		try {
			...
			trans = kkhistory.newTransactionHistory(type, transactionId);
	...
	public Object processWithEventLog(ProceedingJoinPoint pjp,
		...
		try
		{
			...
			event = kkhistory.newEventHistory(type, newEventId);
